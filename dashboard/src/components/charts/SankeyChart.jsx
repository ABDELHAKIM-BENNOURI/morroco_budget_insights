...
export default function SankeyChart() {
  const { figure, error, loading } = usePlotlyFigure('sankey_figure');
  ...
  const layout = useMemo(() => {
    ...
    return {
      ...figure.layout,
      autosize: true,
      margin: { ...(figure.layout.margin || {}), l: 20, r: 20 },
    };
  }, [figure]);
  ...
  if (error) {
    return (
      <div
        ...
        style={{ height: HEIGHT }}
      >
        Impossible de charger sankey_figure.json — {error}.
        <br />
